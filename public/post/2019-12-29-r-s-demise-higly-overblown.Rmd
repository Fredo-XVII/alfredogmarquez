...
Here is a quick look at the download data from the **cranlogs** package.  I created some new features, date factors and period dummy variables, in order to drill into the data graphically. (**NOTE:** download data exludes the last 3 days of 2019, so no data for 29th - 31st, 2019.)
