...
```{r, echo=FALSE, }
knitr::include_graphics("/images/C:\Apps\Apache\Spark\spark-2.3.0\bin.png")
```     
    2. The next step is to add the new variable to your user Path variable.  In the list of variables in the "user variables" section, you are going to see a variable called "Path."  Select this variable and click on the "Edit" icon.  On Windows 10, you get a nice looking list of what is included in the path, but in older versions, you get a long string of variables separated by semi-colons. 
