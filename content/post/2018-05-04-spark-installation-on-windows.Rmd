...
Now that you have the SparkR package loaded, you can create a spark session on you local machine. There are 4 options below that are mandatory.  
  ...
  - The "enableHiveSupport" must be set to FALSE if you are running on local with no HIVE, otherwise and erros trying to fine the HIVE warehouse. If you are running this on a Jupyter notebook on a Hadoop system with HIVE, this should be TRUE.
