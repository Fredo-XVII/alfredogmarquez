...
The process to set up the environmental variables on your machine will be the same for Spark as it is for the other variables below.  So I will use Spark as a example that you can apply to the other variables.
  ...
  2. Locate you environmental varialbes. On Windows 10, you can type environmental into the search bar at the bottom of you screen, then click on "edit system variables." On previous versions of Windows, click on the start menu, right click on computer or control panel, select properties.
