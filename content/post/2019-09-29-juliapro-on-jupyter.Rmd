...
![Jupyter Julia-1.2.0 Kernel Before](/images/GitBash_JuliaPro_before.PNG)

<br></br>

## Copy basic JuliaPro kernel to a file named juliapro-1.2

4. **Make a copy of the Julia-1.2, renamed JuliaPro-1.2**: Create a kernel new file for the JuliaPro-1.2.0 Julia executable. Change the path name to JuliaPro 1.2.0 from Julia 1.2.0.  Now Jupyter will display JuliaPro-1.2.0 for the JuliaPro-1.2.0 install instead of Julia-1.2.0.
