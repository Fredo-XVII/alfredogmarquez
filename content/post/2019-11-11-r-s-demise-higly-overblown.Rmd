...
There will be 3 sets of data that I will be working with for this analysis.  The first will be the R downloads from the **cranlogs** package.  This data comes from the RStudio CRAN mirror, so it is just 1 CRAN mirror of dozens of mirrors available around the world.  I will use this dataset as a proxy for all R downloads world wide.  Second, I will use data from the **rversions** package in order to get R version release dates.  The version dates data will be used to label the graphs and to understand some of the behavior in the downloads.  The third data set that will use comes from the **gtrends** package.  I will use this data as a proxy for what the is being observed by the TOIBE Index and the PYPL Index.  Finally, I research some dates that I felt were relevant after analyzing the data.  For example, Hadley Wickham's introduction of the tidyverse at teh useR! 2016 conference at the end of June 2016.
