...
From the yearly trend above there are 2 interesting behaviors.  First, is the year over year decline in 2016 and the recovery in 2017.  If you look at the graph below you will notice that R downloads are in declline all of 2015 and bottom out in the middle of 2016.  I wondered what happened in 2016 that broke the downward trend.  As I thought about 2016, I remembered that I attended the useR! Conference in Palo Alto that summer.  At the conference Hadley Wickham officially announced idea of the **Tidyverse**, and ending all references to the term **Hadleyverse**, which was the name that had been circling to describe the Tidyverse ecosystem.  We all laugh as we watched Hadleyverse catch fire on screen because it conveyed how humble Hadley truely is.  I regress.  His speech was given on Wednesday June 29th, 2016 (see below week of June 26th).  The week of July 31st 2016 is the start of searches on Google (data from gtrend package) and Tidyverse 1.0.0 is released 1.5 months later.  Below you can see that the week that the term tidyverse search begin to appear on Google Trends R downloads bottom out and rebound.  

In statistics there is this idea that the probability of 2 independents events corresponding together is nearly zero.  In other words, if there is a policy change and a corresponding change in an outcome, the probability that these 2 things occur together would be nearly zero if it were to happen by chance.  Although I have no way to prove this, but from the data below I would make the statement that idea of the Tidyverse has had a positive impact on R downloads.  From my experience, **dplyr** really made R easy to pick up, familiar, and approachable.  Base R was much harder to pick up in comparison.  What this shows is that the Tidyverse reduce the barriers to entry for new R users by making R easier to learn and use.  In economics this would translate to a reduction in  the costs of learning R and thereby increaing the return on investment from the time spend in learning R.   
...
Second, is the large increase in year over year growth in 2019.
```{r, echo=FALSE, warning=FALSE}
